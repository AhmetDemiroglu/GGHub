...
namespace GGHub.Infrastructure.Migrations
{
    ...
    [Migration("20260813054309_AddReleaseDateVerifiedAt")]
    partial class AddReleaseDateVerifiedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GGHub.Core.Entities.BirthdayGreeting", b =>
                {
                    ...
                    b.HasIndex("UserId", "GreetingYear")
                        .IsUnique()
                        .HasDatabaseName("IX_BirthdayGreetings_UserId_GreetingYear");

                    b.ToTable("BirthdayGreetings");
                });
            ...
            modelBuilder.Entity("GGHub.Core.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTime?>("IgdbCheckedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int?>("IgdbRatingCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("ReleaseDateVerifiedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("TrendScoreUpdatedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("GGHub.Core.Entities.UserNotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
