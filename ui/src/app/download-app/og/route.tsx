...
const GOOGLE_PLAY_PATH =
    "M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 01-.61-.92V2.734a1 1 0 01.609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.198l2.807 1.626a1 1 0 010 1.73l-2.808 1.626L15.206 12l2.492-2.491zM5.864 2.658L16.8 8.99l-2.302 2.302-8.634-8.634z";
                        ...
                        <div style={{ display: "flex", alignItems: "center" }}>
                            ...
                            >
                                <svg width="24" height="24" viewBox="0 0 24 24">
                                    <path fill="white" d={GOOGLE_PLAY_PATH} />
                                </svg>
                                <div style={{ display: "flex", marginLeft: "12px", color: "white", fontSize: "24px", fontWeight: 700 }}>Google Play</div>
                            </div>
                        </div>
                        <div style={{ display: "flex", marginTop: "20px", color: "rgba(255,255,255,0.55)", fontSize: "22px" }}>gghub.social</div>
                    </div>
                </div>
